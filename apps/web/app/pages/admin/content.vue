      ...
      <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
          ...
          <BentoCard>
            ...
            <div class="space-y-3">
              <div v-for="(item, i) in current.stats.items" :key="i" class="grid grid-cols-[1fr_2fr_auto] gap-2 items-end">
                <UiInput v-model="item.value" :label="i === 0 ? 'Valoare' : ''" :id="`stat-v-${i}`" />
                <UiInput v-model="item.label" :label="i === 0 ? 'Etichetă' : ''" :id="`stat-l-${i}`" />
